...
- pandas.DataFrame.duplicated 链接: https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.duplicated.html

- pandas.DataFrame.drop_duplicates链接: https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.drop_duplicates.html

- 返回DataFrame或者array的行数 链接: [http://sofasofa.io/forum_main_post.php?postid=1000472](http://sofasofa.io/forum_main_post.php?postid=1000472)

- Convert Z-score (Z-value, standard score) to p-value for normal distribution in Python 链接: https://stackoverflow.com/questions/3496656/convert-z-score-z-value-standard-score-to-p-value-for-normal-distribution-in

- pandas.get_dummies  链接: http://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.get_dummies.html
